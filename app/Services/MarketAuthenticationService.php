...
class MarketAuthenticationService
{
    ...
    /**
     * The client username to identify the password client in ther API
     * @var string
     */
    protected $passwordClientUsername;

    /**
     * The client password to identify the password client in ther API
     * @var string
     */
    protected $passwordClientPassword;
    ...
    public function __construct()
    {
        ...
        $this->passwordClientUsername = config('services.market.password_client_email');
        $this->passwordClientPassword = config('services.market.password_client_password');
    }
    ...
    public function getPasswordToken()
    {
        $formParams = [
            ...
            'username' => $this->passwordClientUsername,
            'password' => $this->passwordClientPassword,
            'scope' => '*',
        ];
    ...
    public function refreshAuthenticatedUserToken($user)
    {
        ...
        if (!isset($tokenData)) {
            ...
            $tokenData = $this->getPasswordToken();
        }
